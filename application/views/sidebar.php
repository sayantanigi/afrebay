                ...
                <div class="navi">
                    <ul>
                        ...
                        <li <?php if($seg1=='subscription') { ?> class="active" <?php } ?>>
                            <a href="<?= base_url('subscription')?>"><i class="fa fa-bar-chart" aria-hidden="true"></i>
                        ...
                        <li <?php if($seg1=='education-list') { ?>class="active" <?php } ?>>
                            <a href="<?= base_url('education-list')?>"><i class="la la-graduation-cap" aria-hidden="true"></i>
                                <span class="hidden-xs hidden-sm">Education</span>
                            </a>
                        </li>
                        <li <?php if($seg1=='workexperience-list') { ?>class="active" <?php } ?>>
                            <a href="<?= base_url('workexperience-list')?>"><i class="fa fa-file" aria-hidden="true"></i>
