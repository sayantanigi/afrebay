...
<footer>
    ...
    <div class="bottom-line">
        <div style="color: #fff;text-align: left;width: 48%;display: inline-block;float: left;margin-left: 60px;">Copyright © <?php echo date('Y')?> Afrebay. All rights reserved.</div>
