...
<div class="col-md-12 col-sm-12 display-table-cell v-align">
    <div class="user-dashboard Admin_Profile">
        <form class="form" action="<?php echo base_url('user/Dashboard/update_profile')?>" method="post"
                        ...
                        <div class="bootstrap snippet">
                            <div class="new-pro">
                                <a href="#" class="pull-right">
                                    ...
                                    <?php } else{?>
                                    <img class="img-circle img-responsive"
                                        src="<?php echo base_url('uploads/users/'.$userinfo->profilePic); ?>"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="firstname" id="firstname"
                                                    ...
                                                    required onkeypress="only_alphabets(event)" />
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="first_name">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="mobile" id="mobile"
                                                    placeholder="Phone Number" value="<?php echo $userinfo->mobile;?>"
                                                    required onkeypress="only_number(event)" maxlength="10" />
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="first_name">
                                                ...
                                                <input type="text" class="form-control" name="email" id="email"
                                                    placeholder="xyz@example.com" readonly
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <select name="gender" class="form-control" required
                                                    ...
                                                    <option value="Male"
                                                        <?php if(@$userinfo->gender=='Male'){ echo "selected";}?>>Male
                                                    </option>
                                                    <option value="Female"
                                                        <?php if(@$userinfo->gender=='Female'){ echo "selected";}?>>
                                                        Female</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <br>
                                                <input type="text" name="skills" required id="skills"
                                                    class="form-control" value="<?= @$userinfo->skills?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="zip" id="zip"
                                                    placeholder="Zip Code" value="<?php echo @$userinfo->zip;?>"
                                                    required onkeypress="only_number(event)" maxlength="6" />
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="last_name">
                                                    <h4>Address</h4>
                                                ...
                                                <input type="text" class="form-control" name="address" id="location"
                                                    placeholder="Location" value="<?= $userinfo->address ?>"
                                                    autocomplete="off" />
                                                <input type="hidden" name="latitude" id="search_lat"
                                                    value="<?= $userinfo->latitude ?>">
                                                <input type="hidden" name="longitude" id="search_lon"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <?php } else{?>
                                                <a
                                                    href="<?php echo base_url('uploads/users/resume/'.$userinfo->resume); ?>" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <?php } else{?>
                                                <img class="img-circle img-responsive"
                                                    src="<?php echo base_url('uploads/users/additional_image/'.$userinfo->additional_image); ?>"
                                                    style="width:60px;height: 60px;" /></a>
                                                <input type="hidden" name="old_additionalimage"
                                                    value="<?= $userinfo->additional_image ?>">
                                                <?php } }else{?>
                                                <img class="img-circle img-responsive"
                                                    src="<?php echo base_url('uploads/no_image.png')?>"
                                                    style="width:60px;height: 60px;" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <textarea class="form-control" name="short_bio"
                                                    placeholder="Short Bio"><?= @$userinfo->short_bio ?></textarea>
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="last_name">
                                                    <h4>Short Video</h4>
                                                ...
                                                <video width="200" controls autoplay>
                                                    <source src="<?= base_url('uploads/video/'.$userinfo->video) ?>"
                                                        style="width:50px;height:50px;" type="video/mp4">
                                                    <source src="<?= base_url('uploads/video/'.$userinfo->video)?>"
                                                        style="width:50px;height:50px;" type="video/ogg">
                                                </video>
