                            ...
                            <div class="tab-pane fade show active" id="profile_settings" role="tabpanel">
                                <form method="post" action="<?= admin_url('login/update_profile')?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="media align-items-center">
                                            <div class="media-left">
                                                ...
                                                <div class="media-body">
                                                    <div class="uploader">
                                                        <input type="file"  name="profile" class="btn btn-secondary btn-sm ml-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?= $get_admin->username?>" disabled style="width: 66%;">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="change_password" role="tabpanel">
                                    <form method="post">
                                        ...
                                        <div class="mt-4 save-form">
                                            <button class="btn save-btn btn-primary" type="button" onclick="return change_password();">Save</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
