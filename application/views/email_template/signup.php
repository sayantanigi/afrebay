...
<body>
	<div style="width:600px;margin: 0 auto;background: #fff;font-family: 'Poppins', sans-serif; border: 1px solid #e6e6e6;">
		<div style="padding: 30px 30px 15px 30px;box-sizing: border-box;">
    		...
    		<p style="list-style: none;"><b>Team Afrebay</b></p>
        ...
        <footer style="height:25px;width:100%;background: #F44C0D;"><span style="padding-left: 10px; width:100%; display: block; margin-bottom: 20px; text-align: center;"> Copyright &copy; <?=date('Y')?> Afrebay right reserverd</span></footer>
	</div>
</body>
</html>
